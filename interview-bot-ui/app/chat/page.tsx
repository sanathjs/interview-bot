...
export default function ChatPage() {
  ...
  return (
    <div style={{
      ...
      {/* Sub-header — single compact row, always fits mobile */}
      <div style={{
        padding: "8px 12px", display: "flex", alignItems: "center",
        justifyContent: "space-between", background: C.header,
        borderBottom: `1px solid ${C.border}`, gap: 8, minHeight: 52,
      }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0, flex: 1 }}>
            ...
            <img src="/profile-avatar.jpg" alt="Sanath"
              ...
              onError={e => {
                ...
                if (e.currentTarget.parentElement) {
                  ...
                  e.currentTarget.parentElement.innerHTML = `<span style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:#f59e0b">S</span>`;
                }
              }}
            />
          </div>
          <div style={{ minWidth: 0 }}>
            ...
            {/* Meta — truncates gracefully on small screens */}
            <div style={{
              display: "flex", alignItems: "center", gap: 5, marginTop: 2,
              overflow: "hidden",
            }}>
              <span style={{ fontSize: 11, color: C.muted, whiteSpace: "nowrap" }}>
                {ROUND_LABELS[roundType] || "General"}
              </span>
              {companyName && <>
              ...
              {avgConfidence !== null && <>
                <span style={{ color: C.border, fontSize: 10 }}>·</span>
                <span style={{ fontSize: 11, fontWeight: 600, color: confColor, whiteSpace: "nowrap" }}>
                  {confPct}%
                </span>
              </>}
            </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
          ...
          {/* End session — icon only on mobile, text on desktop */}
          <button onClick={handleEndSession} disabled={ending} style={{
            ...
            opacity: ending ? 0.5 : 1, whiteSpace: "nowrap",
          }}>
