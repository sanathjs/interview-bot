...
export default function Navbar() {
  ...
  return (
    <>
      ...
      `}</style>
      <nav
        className={isChatPage ? "navbar-chat-hide" : ""}
        style={{
          padding: "10px 16px",
        ...
        <Link href="/" style={{
          ...
          <div style={{
            ...
            boxShadow: "0 0 12px rgba(245,158,11,0.3)", flexShrink: 0,
          }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
              <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" fill="white"/>
            </svg>
          </div>
          <span style={{ fontSize: 13, fontWeight: 600, color: C.text }}>Interview Bot</span>
        </Link>
